...
YELLOW_SPACESHIP_IMAGE =pygame.image.load(os.path.join('Items','spaceship.png'))
YELLOW_SPACESHIP = pygame.transform.scale(YELLOW_SPACESHIP_IMAGE,(55,40))
RED_SPACESHIP_IMAGE =pygame.image.load(os.path.join('Items','spaceship.png'))
RED_SPACESHIP = pygame.transform.scale(pygame.transform.rotate(RED_SPACESHIP_IMAGE, 180),(55,40))

SPACE = pygame.transform.scale(pygame.image.load(
    os.path.join('Items', 'space.png')), (WIDTH, HEIGHT))
